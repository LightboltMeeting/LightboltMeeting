 ...
 */
public class DiscardMeetingSubcommand extends Subcommand implements ISlashCommand {

	public DiscardMeetingSubcommand() {
		this.setSubcommandData(new SubcommandData("discard", "Discards a single Meeting.")
