...
public class LocalizationTests {
	...
	public static void main(String[] args) {
		for (var language : Language.values()) {
			...
			sb.append("\nMEETING:CREATION:CREATION_TIMEZONE_PLACEHOLDER: " + creation.getCREATION_TIMEZONE_PLACEHOLDER());
			...
			sb.append("\nMEETING:CREATION:CREATION_TIMEZONE_LABEL: " + creation.getCREATION_TIMEZONE_LABEL());
			...
			sb.append("\nMEETING:CREATION:CREATION_INVALID_TIMEZONE: " + creation.getCREATION_INVALID_TIMEZONE());
